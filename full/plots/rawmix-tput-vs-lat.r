...
d <- tryCatch(
  {
    ...
    write.csv(subset(d, select = c('name', 'nclients', 'nthreads', 'cc', 'phasing', 'rate', 'alpha', 'commute_ratio', 'timeout_scaling', 'throughput', 'op_timeouts', 'avg_latency_ms')), file = 'rawmix-tput-vs-lat.csv')
