...
conference:
  ...
  year: 2015
  copyrightdata: 978-1-4503-3537-9/15/04
...
```{r throughput, include=F, fig.width=2.8, fig.height=2.8}
d <- data.papoc(where="name like 'claret-v0.14%'")
